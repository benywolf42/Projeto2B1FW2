...
$apoio_usr = mysqli_fetch_array(mysqli_query($conn, "SELECT idUsuario FROM Usuario WHERE login = '$login'"));
...
$get_petID = mysqli_fetch_array(mysqli_query($conn, "SELECT idPet FROM Pet WHERE nome_provisorio = '$nomePet'"));
$_SESSION['petID'] = $get_petID[0] ; // to tentando pegar o id do pet e usar na query da linha 36 do envioFotosPet. Só vai hardcoded, variavel nao funfa. Mas deve estar no caminho
